/*
  ...
  - You are about to drop the column `status` on the `Swipe` table. All the data in the column will be lost.
  - Added the required column `userStatus` to the `Swipe` table without a default value. This is not possible if the table is not empty.
